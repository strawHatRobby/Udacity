...
public class PhrasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WordAdapter<Word> phrasesListAdapter = new WordAdapter<Word>(this, phrases);
        ListView phrasesListView = (ListView)findViewById(R.id.activity_phrases);
        phrasesListView.setAdapter(phrasesListAdapter);
    }
}
